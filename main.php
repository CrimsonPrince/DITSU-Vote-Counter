      ...
      <div id="content">
         <form method="post" action="register.php" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin">
			...
			<div class="w3-row w3-section">
               ...
               <div class="w3-rest">
                  <input class="w3-input w3-border" type="username" name="username" required placeholder="Candidate 1"><span class="error"><span><?php echo $nameErr;?></span>
               </div>
            </div>
			...
			<div class="w3-row w3-section">
               <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-user"></i></div>
               <div class="w3-rest">
                  <input class="w3-input w3-border" type="username" name="username" required placeholder="Candidate 2"><span class="error"><span><?php echo $nameErr;?></span>
               </div>
            </div>
